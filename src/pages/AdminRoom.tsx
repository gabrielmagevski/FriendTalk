...
export function AdminRoom() {
    ...
    async function handleEndRoom() {
        ...
        swalWithBootstrapButtons.fire({
            title: 'Tem certeza?',
            text: "Fechando a sala você não terá mais acesso a ela e mais ninguém.",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                swalWithBootstrapButtons.fire(
                    'Cancelado',
                    'Obrigado por permanecer conectado.',
                    'error'
                )
            }
        })
    ...
    async function handleComeBack() {
        ...
        await swalWithBootstrapButtons.fire({
            title: 'Tem certeza que deseja sair do modo Administrador?',
            text: `Caso queira voltar, copie o link e acesse. https://letmeask-6aa0f.web.app/admin/rooms/${roomId}`,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonText: 'Sim',
            cancelButtonText: 'Cancelar!',
